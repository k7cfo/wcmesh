  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Tagline */}
        <article className="font-mono text-wcm-green text-lg sm:text-xl mb-8">
          <span className="text-wcm-green" aria-hidden="true">{">"}</span>{" "}
        ...
        <nav className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="font-mono px-8 py-3 bg-wcm-green text-primary-foreground font-bold hover:bg-wcm-yellow transition-colors border-2 border-wcm-green hover:border-wcm-yellow"
          >
            {"[GET STARTED]"}
          </a>
        </nav>
